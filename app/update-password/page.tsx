    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-6">
      ...
      >
        ...
        <input
          ...
          required
          className="w-full rounded-xl px-4 py-3 bg-white text-gray-900 border border-gray-300 focus:border-dynamo-blue focus:outline-none focus:ring-2 focus:ring-dynamo-blue"
        />
